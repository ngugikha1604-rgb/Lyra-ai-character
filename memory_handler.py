...
from prompts import MEMORY_EXTRACT_SYSTEM, SUMMARIZE_PROMPT, MEMORY_COMPRESSION_PROMPT, DIARY_GENERATION_PROMPT
...
class MemoryHandlerMixin:
    ...
    Handles extraction, summarization, and diary management.
    """
